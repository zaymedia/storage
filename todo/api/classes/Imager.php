...
class Imager
{
    ...
    public static function withoutRootDir($dir, $path): string
    {
    ...
    public function optimize(string $path, int $quality = 90, ?int $rotate = null)
    {
        if ($rotate === null) {
            $rotate = 0;
        }
    ...
    public function cropSquare(string $path, array $params = null, int $quality = null, string $new_filename = null): ?string
    {
        $this->setImage($path);
